  generateCharacterIntro(characters, setting) {
    if (!characters) {
      return this.fillTemplate("{protagonist} moved through the {place} like someone who had forgotten how to be afraid. Or maybe they had simply run out of fear, spent it all on something that couldn't save them.");
    }
